<?php
/**
 * Plugin Name: Home Category Posts Widget
 */

add_action( 'widgets_init', 'mvp_catposts_load_widgets' );

function mvp_catposts_load_widgets() {
	register_widget( 'mvp_catposts_widget' );
}

class mvp_catposts_widget extends WP_Widget {

	/**
	 * Widget setup.
	 */
	function mvp_catposts_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mvp_catposts_widget', 'description' => __('A widget that displays a list of posts from a category of your choice.', 'mvp_catposts_widget') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'mvp_catposts_widget' );

		/* Create the widget. */
		$this->__construct( 'mvp_catposts_widget', __('Top News: Home Category Posts Widget', 'mvp_catposts_widget'), $widget_ops, $control_ops );
	}
