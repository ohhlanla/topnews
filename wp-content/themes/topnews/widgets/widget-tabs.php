...
class mvp_sidetab_widget extends WP_Widget {
	...
	function mvp_sidetab_widget() {
		...
		/* Create the widget. */
		$this->__construct( 'mvp_sidetab_widget', __('Top News: Sidebar Tabs Widget', 'mvp_sidetab_widget'), $widget_ops, $control_ops );
	}
		...
		<div class="sidebar-widget-content">
			<div class="tabber-contain left relative">
				...
				<div id="tab3" class="tabber-content">
					<ul class="sidebar-list-tabs left relative">
						<?php $args = array( 'number' => $comment_number ); $comments = get_comments( $args ); if ( $comments ) { foreach ( $comments as $comment ) { ?>
							<li>
								<div class="sidebar-list-img left relative">
								...
								<div class="sidebar-list-text left relative">
									...
									<p class="comment-tab-text"><a href="<?php echo get_permalink($comment->comment_post_ID); ?>" title="<?php echo strip_tags($comment->comment_author); ?> on <?php echo get_the_title($comment->comment_post_ID); ?>"><?php
