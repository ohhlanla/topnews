<?php
/**
 * Plugin Name: Home Tag Featured Widget
 */
...
class mvp_tagfeat_widget extends WP_Widget {
	...
	function mvp_tagfeat_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mvp_tagfeat_widget', 'description' => __('A widget that features the most recent post from a tag of your choice.', 'mvp_tagfeat_widget') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'mvp_tagfeat_widget' );

		/* Create the widget. */
		$this->__construct( 'mvp_tagfeat_widget', __('Top News: Home Tag Featured Widget', 'mvp_tagfeat_widget'), $widget_ops, $control_ops );
	}
